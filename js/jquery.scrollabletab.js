...
( function( factory, global ) {
    ...
    var tabs = $.extend({}, $.ui.tabs.prototype),  _super = {
            ...
            if (o.scrollable) {
				...
				function _init() {
					...
					$navNext.click(function(){
						var $nextTab = $nav.find('li.ui-tabs-active').next('li');
						if($nextTab.length) {
					...
					$navPrev.click(function(){
						var $prevTab = $nav.find('li.ui-tabs-active').prev('li');
						if($prevTab.length) {
				...
				$.fn.refreshTabs = function() {
					//Re-select the tab
					var $selTab = $nav.find('li.ui-tabs-active');
					var $eventTab = $selTab.find('a');
					$tabs.trigger('tabsbeforeactivate', [ { oldTab : eventTab, newTab : eventTab } ]);
